...
class flanger(commands.Cog, ffmpeg_cog):
    ...
    async def create_output_video(self, ctx: bridge.BridgeExtContext, speed):
    ...
    @bridge.bridge_command(help='speed: the speed of the oscilation in Hz')
    @commands.cooldown(1, 30, commands.BucketType.user)
    @bridge.guild_only()
    @decorators.Async.typing
    @decorators.Async.defer
    async def flan(self, ctx: bridge.BridgeExtContext, speed=10.0):
